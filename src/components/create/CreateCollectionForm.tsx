...
const CreateCollectionForm: React.FC = () => {
  ...
  const ownerCleaned = isAddress(formData.owner) ? formData.owner : zeroAddress
  ...
  const logicInitInput = encodeAbiParameters(
    ...
    [
        ...
        BigInt(0), // mintNewPrice. hardcoded to zero
    ]
)  
  ...
  return (
    <form onSubmit={handleSubmit} className="text-black w-full max-w-xl mx-auto grid grid-cols-2 gap-4">
        ...
        <div className="col-span-2">
            <label htmlFor="symbol" className="block text-sm font-medium text-gray-400">
                Symbol:
            </label>
            <input
                type="text"
        ...
        <div className="col-span-2">
            <label htmlFor="owner" className="block text-sm font-medium text-gray-400">
                Owner:
            </label>
            <input
                type="text"
        ...
        <div className="col-span-2">
            ...
            type="submit"
            className="w-full flex flex-row justify-center py-2 px-4 text-sm font-medium text-white bg-gray-600 hover:bg-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
            {createStatus}
            </button>
        </div>
